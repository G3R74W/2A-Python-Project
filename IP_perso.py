...
def get_ip():
    ...
    :return: revoie l'IP de l'ordinateur sur le reseau
    """
...
def list_host (IP, min = 0, max = 255):
    """
    fonction qui permet d'avoir l'ensemble des ordinateurs connecte dans une plage voulu
    :param IP: IP de l'utilisateur
    :param min: borne inferieur de plage voulu
    :param max: borne superieur de plage voulu
    :return: liste contenant tous les appareil connecte dans la plage
    """
